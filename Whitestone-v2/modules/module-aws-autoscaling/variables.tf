...
variable create_predictive_asg_policy {
  description = "Determines whether to create autoscaling group policy or not"
  type        = bool
  default     = false
}
variable asg_predictive_policies {
  description = "Map of autoscaling group policy to create"
  type        = map(any)
  default     = {}
}
...
variable "default_alarms_mem_enabled" {
  type        = bool
  default     = false
  description = "Enable or disable cpu and memory Cloudwatch alarms"
}
variable "create_asg_policy_mem" {
  description = "Determines whether to create autoscaling group policy or not"
  type        = bool
  default     = false
}
